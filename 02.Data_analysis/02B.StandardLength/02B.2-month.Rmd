...
m2.sl.obs.summarize2 <- m2.sl.obs.summarize |> 
  group_by(TEMPERATURE) |> 
  mutate(temp_mean =mean(mean.sl), 
         temp_sd =sd(mean.sl)) |> 
  distinct(temp_mean, .keep_all = TRUE)

m2.plot2 <- ggplot(m2.sl.obs.summarize, aes(x=TEMPERATURE, y=mean.sl, color=TEMPERATURE)) + 
  geom_pointrange(data=m2.sl.obs.summarize2, 
                  aes(x=TEMPERATURE, 
                      y=temp_mean, 
